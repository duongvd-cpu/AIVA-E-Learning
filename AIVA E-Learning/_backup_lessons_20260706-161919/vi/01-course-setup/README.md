...
```bash|powershell
git sparse-checkout set 01-course-setup 02-intro-to-ai-agents
```
...
Trong notebook Bài 6 (`18-building-trustworthy-agents/code_samples/06-system-message-framework.ipynb`), có sẵn phương án giải quyết đã bị comment. Bỏ comment `connection_verify=False` khi tạo client:
...
[Giới thiệu về AI Agents và Các trường hợp sử dụng Agent](../02-intro-to-ai-agents/README.md)
