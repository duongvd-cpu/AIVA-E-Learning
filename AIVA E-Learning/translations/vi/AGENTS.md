...
2. **Đi tới thư mục bài học** (ví dụ, `02-intro-to-ai-agents/code_samples/`)
...
1. **01-course-setup** - Bắt đầu thiết lập môi trường
2. **02-intro-to-ai-agents** - Tìm hiểu cơ bản AI agent
3. **03-explore-agentic-frameworks** - Tìm hiểu các framework khác nhau
4. **04-agentic-design-patterns** - Mẫu thiết kế cốt lõi
...
- Tham khảo [Course Setup](./01-course-setup/README.md) cho hướng dẫn chi tiết
